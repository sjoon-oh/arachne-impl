...
PROFILES=(
  "align_workload_a_10m:$CONFIG_DIR/spacev_streaming_workload_a_align.ini"
  "nonalign_workload_a_10m:$CONFIG_DIR/spacev_streaming_workload_a_nonalign.ini"
  "random_workload_a_10m:$CONFIG_DIR/spacev_streaming_workload_a_random.ini"
  "align_workload_b_10m:$CONFIG_DIR/spacev_streaming_workload_b_align.ini"
  "nonalign_workload_b_10m:$CONFIG_DIR/spacev_streaming_workload_b_nonalign.ini"
  "random_workload_b_10m:$CONFIG_DIR/spacev_streaming_workload_b_random.ini"
  "align_workload_c_10m:$CONFIG_DIR/spacev_streaming_workload_c_align.ini"
  "nonalign_workload_c_10m:$CONFIG_DIR/spacev_streaming_workload_c_nonalign.ini"
  "random_workload_c_10m:$CONFIG_DIR/spacev_streaming_workload_c_random.ini"
)

for entry in "${PROFILES[@]}"; do
  profile="${entry%%:*}"
  ini="${entry#*:}"
  out_dir="$REPO_ROOT/scripts/workload/spacev1b/$profile"
...
echo "=== done: see scripts/workload/spacev1b/*/set_1/ ==="
